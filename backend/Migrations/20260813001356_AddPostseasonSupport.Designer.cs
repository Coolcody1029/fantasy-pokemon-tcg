...
namespace backend.Migrations
{
    ...
    [Migration("20260813001356_AddPostseasonSupport")]
    partial class AddPostseasonSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.RegionalEvent", b =>
                {
                    ...
                    b.Property<string>("FantasyStage")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("backend.Models.RegionalLineupEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LeagueMemberId", "RegionalEventId", "PlayerId")
                        .IsUnique();

                    b.ToTable("RegionalLineupEntries");
                });
            ...
            modelBuilder.Entity("backend.Models.Matchup", b =>
                {
                    ...
                    b.HasOne("backend.Models.LeagueMember", "Winner")
                        .WithMany()
